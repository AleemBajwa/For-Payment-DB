...
df = df[df['Sr'].astype(str).str.lower() != 'sr']           # Remove repeated headers in rows
...
# Keep only strictly numeric amounts
...
with col1:
    st.metric("👩‍🦰 Unique Mother CNICs", df['MotherCNIC'].nunique())
